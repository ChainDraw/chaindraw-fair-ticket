...
contract LotteryEscrow is ERC721, ERC721URIStorage, ConfirmedOwner, ReentrancyGuard, VRFV2WrapperConsumerBase {
    event LotteryEscrow__Deposited(string indexed concertId, uint256 indexed ticketType, address buyer, uint256 money);
    event LotteryEscrow__Refunded(string indexed concertId, uint256 indexed ticketType, address buyer, uint256 money);
    event LotteryEscrow__ClaimedFund(
        string indexed concertId, uint256 indexed ticketType, address organizer, address winner, uint256 money
    );
    event LotteryEscrow__NonWinner(
        string indexed concertId, uint256 indexed ticketType, address nonWinner, uint256 money
    );
    event LotteryEscrow__Winner(string indexed concertId, uint256 indexed ticketType, address winner);
